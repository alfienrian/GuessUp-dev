...
// TODO: FIX input masih belum terhapus saat state count sama
@Composable
                    ...
                    onValueChange = { it ->
                        if (it.length <= 1) {
                            ...
                            when {
                                ...
                                it.isEmpty() && previousValue.isNotEmpty() && i > 0 -> {
                                    focusRequesters[i - 1].requestFocus()
                                }
                            }
                        }
